...
(1, 'Rekaman Tenang', 2, '3'),
(2, 'Rekaman Merasa Indah', 1, '3'),
(5, 'Cinta dan Rahasia', 10, '4'),
(6, 'Rekaman Kebutuhan Hati ini', 9, '4'),
(7, 'Mata Indah Bola Pingpong', 4, '4'),
(8, 'Rekaman Nw I Know', 5, '4');
...
--
ALTER TABLE `tb_album`
  MODIFY `alb_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tb_track`
  MODIFY `trc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
